:github-address: https://github.com/hazelcast-guides/hazelcast-client-quarkus/
...
- xref:hazelcast-embedded-microprofile:ROOT:index.adoc[Hazelcast in Microprofile]
